...
public class BSTree <T extends Comparable> {
	...
	if(r == null){
	    ...
	    return 1 + Math.max(getHeight(r.getLeft()),	getHeight(r.getRight()));
	}
    }
    ...
    */
	...
	BSTree<Integer> q = new BSTree<Integer>();
	for(int i = 0; i < 8; i++){
	    q.add((int) (Math.random() * 5));
	}
